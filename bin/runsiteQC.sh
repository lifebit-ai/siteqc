...
export wd='/re_gecip/shared_allGeCIPs/drhodes/Aggregation_79k/src_actual'
...
export kgp3_sample_table="1KGP3.sample_table"
export super_pop_codes="super_pop_codes.tsv"
export kgp3_unrel="1KGP3_30K_unrel_autosomes.fam"
###
