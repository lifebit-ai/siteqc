...
def helpMessage() {
    ...
    Mandatory arguments:
      ...
      --triofile                      File describing the family trios of participants in bcf files.
                                      Input to triodata_define process.
      --included_samples              File with a list of samples' (participants') platekeys to include in analysis..
                                      Input to triodata_define process.
    ...
    Optional arguments:
      --updfile                       File with a list of participants' platekeys to be exluded from the analysis.
                                      Optional input to triodata_define process.

      --triodata_keep_pheno           File with a list of participants to keep in analysis.
      --triodata_fam                  A .fam file describing families of participants selected to keep in analysis.
                                      If both triodata files above are provided - triodata_define process is skipped and
                                      these files are used instead.

      --mend_err_p3_keep_fam          A .fam file of families that should be kept after mend_err_* filtering processes.
